...
--
-- Machine: localhost
-- Genereertijd: 10 jun 2015 om 10:35
...
-- Databank: `cinema7`
--
CREATE DATABASE IF NOT EXISTS `cinema7` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cinema7`;
...
(18, 'hallo', 'hallo', 111, 'Komedie', 'ALL', 'Default.jpg', 1, NULL, 'InBios');
...
(2, 'Ilse', 'de Groot', 'Markt 13', '1241 BA', '', '06-43763212', 'Ilse.de.Groot@cinema7.nl', 'Ilse', '476915be4d2b168468341c77555e74f4d8dfb6422ddebbf63d053dcb9acc4bbcfcbb00e22fbdc60381acf1c1490837c942244938e420051b31703d4af13b8b2b', '2302ddecae3eed272659c3754a245301bc41a960811c2dd8f4e330fd2d96c9fc224c1684e9dae19611f1c5abc549cadf4e0c22f60ed69637aded21cdb6c5a69c', 1),
...
(6, 'Jens', 'van Lankveld', 'straat 1', '1234 AB', 'Venhorst', '0123-123456', 'nee@nee.0fucksgiven', 'Jens', '0ead4fba0100886174949928c490332047c0e931a9b45b5eb7a6e291a93e047324b327bf2f2dc1063c74a64b8b14351549840707674a8ec71625ce16566ace06', '111a991b58eba5bb3a75aeb65e714ae4a7a468eed04abb3856f13c05f33f9c99728334c944ff880f0b24172c0c7dce2b1447433b44d2c03d9970f09758167ce3', 1),
(7, 'de', 'de', '', '', '', '06-12345678', 'd@d.d', 'test', 'eb87392e13ddbb64a2475a2cd3661f1650ac6874fd587c5b9983e8af30a4c95ea03c50c6f5f6df3cec544d84613e9b7a93bd4ed46c7a383236bb1e980e4787a7', 'eceae4884df9db290d50bc834b2d9f2e5fdfd472f6a942314d62f278ebbe1ad4c1701ea3ce0a12265cb43e08ba6a7eb1f6d1e4af707baf00b4d99621b2b9482a', 1);
...
CREATE TABLE IF NOT EXISTS `reserveringen` (
  `ReserveringsID` int(11) NOT NULL AUTO_INCREMENT,
  `KlantID` int(11) NOT NULL,
  `VertoningsID` int(11) NOT NULL,
  `AantalKaartjes` int(2) NOT NULL,
  PRIMARY KEY (`ReserveringsID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `vertoningen`
--

CREATE TABLE IF NOT EXISTS `vertoningen` (
  `VertoningsID` int(11) NOT NULL AUTO_INCREMENT,
  `ZaalNR` int(11) NOT NULL,
  `FilmID` int(11) NOT NULL,
  `Datum` date NOT NULL,
  `Tijd` time NOT NULL,
  PRIMARY KEY (`VertoningsID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=57 ;

--
-- Gegevens worden uitgevoerd voor tabel `vertoningen`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `zalen`
--
