	...
	<div class="col-xs-6">
		<form class="form-inline" method="post" action="" >
			<div class="form-group">
				<input class="form-control" id="zoekbedrijf" name="zoekbedrijf" value="<?php echo $zoeken; ?>" placeholder="Zoeken" aria-label="zoeken">
				<button type="submit" name="submit" class="btn btn-default">Zoeken</button>
				<a href="?paginanr=4" class="btn btn-default" role="button">Reset</a><br /><br />
			</div>
		</form>
	</div>
</div>
